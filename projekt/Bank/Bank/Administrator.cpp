...
void Administrator::rejestracja(string id_od_banku, string haslo) {
	// TODO - implement Administrator::rejestracja
	throw "Not yet implemented";
}

void Administrator::odczytaj_dane_administrator() {
	// TODO - implement Administrator::odczytaj_dane_administrator
	throw "Not yet implemented";
}

void Administrator::sprawdz_poprawnosc_danych() {
	// TODO - implement Administrator::sprawdz_poprawnosc_danych
	throw "Not yet implemented";
}

void Administrator::wyswietl_blad() {
	// TODO - implement Administrator::wyswietl_blad
	throw "Not yet implemented";
}
